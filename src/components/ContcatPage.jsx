          ...
          <div className="w-full lg:flex-1 lg:min-w-0 bg-white rounded-[30px] sm:rounded-[40px] p-6 sm:p-10 xl:p-12">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="font-semibold text-white text-sm tracking-widest uppercase px-8 py-3.5 hover:opacity-90 transition-opacity  mt-4 disabled:opacity-60 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                style={{
